...
const RelatedLinks: React.FC<{ links: { label: string; view: string }[]; onNavigate?: (view: string) => void }> = ({ links, onNavigate }) => {
  ...
  return (
    <div className="mt-8 pt-6 border-t border-warm-200">
      <h3 className="text-sm font-bold text-warm-700 mb-3">Pautan Berkaitan</h3>
      <div className="flex flex-wrap gap-3">
        {links.map(({ label, view }) => (
          <button
            key={view}
            onClick={() => onNavigate(view)}
            className="inline-flex items-center gap-1.5 text-sm text-teal-700 hover:text-teal-900 bg-teal-50 hover:bg-teal-100 px-3 py-1.5 rounded-lg transition font-medium"
          >
            {label}
...
export const PrivacyPolicy: React.FC<LegalPageProps> = ({ onNavigate }) => {
  return (
    <div className="bg-white p-8 rounded-2xl shadow-sm border border-warm-200 space-y-6">
      <div className="flex items-center gap-3 text-teal-800 mb-4">
        <Shield className="w-8 h-8" />
        <h2 className="text-2xl font-bold font-display">Dasar Privasi (Privacy Policy)</h2>
      </div>
      <div className="prose prose-warm text-sm max-w-none">
        ...
        <h3 className="text-lg font-bold text-warm-800 mt-4">1. Pengumpulan Maklumat</h3>
        ...
        <h3 className="text-lg font-bold text-warm-800 mt-4">2. Penggunaan Kuki (Cookies)</h3>
        ...
        <h3 className="text-lg font-bold text-warm-800 mt-4">3. Pautan Luar</h3>
        ...
        <h3 className="text-lg font-bold text-warm-800 mt-4">4. Perubahan Dasar</h3>
  ...
  return (
    <div className="bg-white p-8 rounded-2xl shadow-sm border border-warm-200 space-y-6">
      <div className="flex items-center gap-3 text-teal-800 mb-4">
        ...
        <h2 className="text-2xl font-bold font-display">Terma Perkhidmatan (Terms of Service)</h2>
      </div>
      <div className="prose prose-warm text-sm max-w-none">
        <p>Dengan menggunakan KiraFaraid, anda bersetuju dengan terma dan syarat berikut:</p>

        <h3 className="text-lg font-bold text-warm-800 mt-4">1. Tujuan Pendidikan Sahaja</h3>
        ...
        <h3 className="text-lg font-bold text-warm-800 mt-4">2. Penafian Liabiliti</h3>
        ...
        <h3 className="text-lg font-bold text-warm-800 mt-4">3. Rujukan Rasmi</h3>
        ...
        <h3 className="text-lg font-bold text-warm-800 mt-4">4. Harta Intelek</h3>
  ...
  return (
    <div className="bg-white p-8 rounded-2xl shadow-sm border border-warm-200 space-y-6">
      <div className="flex items-center gap-3 text-teal-800 mb-4">
        ...
        <h2 className="text-2xl font-bold font-display">Hubungi Kami</h2>
      </div>
      <div className="prose prose-warm text-sm max-w-none">
        ...
        <div className="bg-warm-50 p-6 rounded-xl border border-warm-200 mt-6">
            <p className="font-semibold text-warm-800">Email:</p>
            <p className="text-teal-600 mb-4">admin@kirafaraid.my</p>

            <p className="font-semibold text-warm-800">Alamat Surat Menyurat:</p>
